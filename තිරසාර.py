...
class CNN:
    ...
    def train(
        ...
        self.training = False  # Set to False during prediction
        ...
        while rp < n_repeat and mse >= error_accuracy:
            ...
            for p in range(len(datas_train)):
               ...
               """
                ...
                # Apply dropout
                if self.training:
                    dropout_mask = np.random.rand(bp_out1.shape[0], bp_out1.shape[1]) > self.dropout_rate
                    bp_out1 *= dropout_mask
                    bp_out1 /= (1 - self.dropout_rate)  # Scale the output
                ...
                if self.training:
                    ...
                    dropout_mask2 = np.random.rand(bp_out2.shape[0], bp_out2.shape[1]) > self.dropout_rate
                    bp_out2 *= dropout_mask2
                    bp_out2 /= (1 - self.dropout_rate)  # Scale the output
    ...
    def predict(self, datas_test):
        ...
        print(f"Elapsed time for predictions: {elapsed_time:.6f} seconds")  # Print elapsed time
